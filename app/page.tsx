            ...
            <div className="mt-8 grid md:grid-cols-2 gap-4">
              <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8">
                ...
                <p className="text-slate-300">
                  You have {user.credits} credits available. Claim your daily bonus or browse the marketplace to find
                  new cards.
                </p>
              </div>

              <Link href="/help">
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 border border-slate-600 rounded-lg p-8 cursor-pointer hover:border-amber-500 transition-all h-full">
                  <h2 className="text-2xl font-bold mb-4 text-amber-400">Need Help?</h2>
                  <p className="text-slate-300">
                    Learn how to play, manage your collection, build decks, and compete in the ladder. View our
                    comprehensive guide.
                  </p>
                </div>
              </Link>
